...
def load(
    ...
    design_details : dict, optional
        Prompt-learning backend configuration forwarded to build_model. Pass
        trainer="MaPLe" details for the patched MaPLe visual/text transformers.
