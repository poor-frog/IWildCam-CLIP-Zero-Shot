import torch
from src.datasets.dataloader import get_dataloader, maybe_dictionarize
...
def eval_single_dataset(image_classifier, dataset, args, classification_head, tau=None, class_priors=None):
    ...
    with torch.no_grad():
        ...
        for i, data in batched_data:
            ...
            logits = get_logits(x, model, classification_head)
...
def evaluate(image_classifier,
    ...
    for i, dataset_name in enumerate(args.eval_datasets):
        ...
        image_classifier_model = getattr(image_classifier, 'module', image_classifier)
        dataset = dataset_class(image_classifier_model.val_preprocess,
